...
foresthr("sysbp_ras", "shf_ras", treatlab = "RASi", treatlabs = c("dose >= 50%", "dose < 50%", "not treated"), adj = FALSE)
```
...
foresthr("sysbp_ras", "shf_ras", treatlab = "RASi", treatlabs = c("dose >= 50%", "dose < 50%", "not treated"), adj = TRUE)
```
...
foresthr("sysbp_bbl", "shf_bbl", treatlab = "Bbl", treatlabs = c("dose >= 50%", "dose < 50%", "not treated"), adj = FALSE)
```
...
foresthr(treatvar = "sysbp_bbl", treatlab = "Bbl", "shf_bbl", treatlabs = c("dose >= 50%", "dose < 50%", "not treated"), adj = TRUE)
```
...
foresthr("sysbp_mra", "shf_mra", treatlab = "MRA", treatlabs = c("treated", "not treated"), adj = TRUE)
```
